    ...
    def response(self, server) -> bytes:
        ...
        match self.command:
            ...
            case Commands.INFO:
                ...
                master_replid = "master_replid:" + server.master_replid
                master_repl_offset = "master_repl_offset:" + server.master_repl_offset
                
                return RedisEncoder.encode_bulk_string(role + "\r\n" + master_replid + "\r\n" + master_repl_offset)
